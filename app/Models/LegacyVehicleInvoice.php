...
class LegacyVehicleInvoice extends Model {
  ...
  static public function getUiid($id) {
    return 'LVIn-' . str_pad($id, 4, '0', STR_PAD_LEFT);
  }

  static public function getItems($req) {
    $items = LegacyVehicleInvoice::
    ...
    foreach ($items as $key => $item) {
      ...
      $item->uiid = LegacyVehicleInvoice::getUiid($item->id);
    }
