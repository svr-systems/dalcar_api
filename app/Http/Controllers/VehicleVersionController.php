...
class VehicleVersionController extends Controller {
  public function index(Request $req) {
    try {
      return $this->apiRsp(
        ...
        ['items' => VehicleVersion::getItems($req)]
      );
    } catch (Throwable $err) {
  ...
  public function show(Request $req, $id) {
    try {
      return $this->apiRsp(
        ...
        ['item' => VehicleVersion::getItem($req, $id)]
      );
    } catch (Throwable $err) {
      return $this->apiRsp(500, null, $err);
    }
  ...
  public function storeUpdate($req, $id) {
    ...
    try {
      ...
      $valid = VehicleVersion::valid($req->all());
