...
class PurchaseOrderController extends Controller
{
  ...
  //   DB::beginTransaction();
  //   try {
  //     $valid = PurchaseOrder::valid($req->all(), $id);
  ...
  public function getPurchaseOrderPayments(Request $req, $vendor_id)
  {
    try {
      return $this->apiRsp(
        200,
        'Registros retornado correctamente',
        ['items' => PurchaseOrder::getPurchaseOrderPayments($req, $vendor_id)]
      );
    } catch (Throwable $err) {
      return $this->apiRsp(500, null, $err);
    }
