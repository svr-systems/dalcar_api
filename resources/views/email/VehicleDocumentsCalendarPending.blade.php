...
@section('content')
  <div>
    <h2 class="font-weight-light">Documentos pendientes por cargar</h2>

    <p class="text">
      Al día <b>{{ $data->date }}</b> se detectaron documentos calendarizados sin evidencia digital.
    </p>
    ...
    <ul class="text" style="margin-top: 8px;">
      @foreach ($data->items as $item)
        <li style="margin-bottom: 6px;">
          ...
          — Tipo: <b>{{ $item->document_type_name }}</b>
